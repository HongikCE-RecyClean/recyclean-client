export const koTranslation = {
  ...
  notifications: {
    ...
    snackbar: {
      ...
      entrySavedLocally: "오프라인으로 로컬에 저장했어요.\n+{{points}}pt 유지",
      ...
      locationError: "위치 정보를 불러오지 못했어요.\n잠시 후 다시 시도해주세요",
      analysisFailedRetry: "분석에 실패했어요.\n다른 각도나 밝은 곳에서 다시 촬영해주세요.",
      analysisLowConfidence: "정확도가 낮아요(60% 이하).\n다시 한 번 촬영해볼까요?",
      emptyPredictions: "분류 결과가 비어있어요.\n물체가 잘 보이도록 다시 촬영해주세요.",
      monthlyGoalSyncFailed: "월간 목표를 동기화하지 못했어요.\n다시 시도해주세요.",
    },
  },
  common: {
    cancel: "취소",
