export const enTranslation = {
  ...
  notifications: {
    ...
    snackbar: {
      ...
      entrySavedLocally: "Saved locally (offline).\n+{{points}}pt applied",
      ...
      locationError: "We couldn't load your location.\nPlease try again.",
      analysisFailedRetry: "Analysis failed.\nTry retaking the photo with better light or angle.",
      analysisLowConfidence: "Low confidence (≤60%).\nPlease retake the photo.",
      emptyPredictions: "No results found.\nPlease retake with the object clearly visible.",
      monthlyGoalSyncFailed: "Couldn't sync the monthly goal.\nPlease try again.",
    },
  },
  common: {
    cancel: "Cancel",
