export const esTranslation = {
  ...
  dashboard: {
    ...
    addEntry: {
      ...
      memo: "Nota",
      memoPlaceholder: "Añadir nota (opcional)",
    },
    materials: {
      plasticPetBottle: {
  ...
  notifications: {
    ...
    snackbar: {
      ...
      entrySavedLocally: "Guardado localmente (sin conexión).\n+{{points}}pt aplicados",
      ...
      locationError: "No pudimos obtener su ubicación.\nInténtelo de nuevo.",
      analysisFailedRetry: "El análisis falló.\nToma otra foto con mejor luz o ángulo.",
      analysisLowConfidence: "Confianza baja (≤60%).\nVuelve a tomar la foto.",
      emptyPredictions: "Sin resultados.\nVuelva a tomar la foto con el objeto bien visible.",
      monthlyGoalSyncFailed: "No se pudo sincronizar la meta mensual.\nInténtalo de nuevo.",
    },
  },
  common: {
    // 취소 버튼 공통 문구
